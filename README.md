...
- 🎉 [giantswarm/cluster-vsphere](https://github.com/giantswarm/cluster-vsphere) ([v0.52.0](https://github.com/giantswarm/cluster-vsphere/releases/tag/v0.52.0), 2 days ago) - Helm chart for deploying Kubernetes clusters on VSphere
- 🎉 [giantswarm/kyverno-app](https://github.com/giantswarm/kyverno-app) ([v0.17.13](https://github.com/giantswarm/kyverno-app/releases/tag/v0.17.13), 2 days ago) - 
- 🎉 [giantswarm/cluster-api-ipam-provider-in-cluster-app](https://github.com/giantswarm/cluster-api-ipam-provider-in-cluster-app) ([v0.1.1](https://github.com/giantswarm/cluster-api-ipam-provider-in-cluster-app/releases/tag/v0.1.1), 3 days ago) - simple controller for IpAddressClaim

#### 🔨 My recent Pull Requests

- 💪 [Create rolebinding for .Release.Namespace implicitly](https://github.com/kedacore/charts/pull/643) on [kedacore/charts](https://github.com/kedacore/charts) (1 day ago)
- 💪 [Downgrade scorecard action to one that worked](https://github.com/k8gb-io/k8gb/pull/1567) on [k8gb-io/k8gb](https://github.com/k8gb-io/k8gb) (5 days ago)
- 💪 [Add stable diffusion use case](https://github.com/kedify/examples/pull/5) on [kedify/examples](https://github.com/kedify/examples) (1 week ago)
...
- [simeji/jid](https://github.com/simeji/jid) - json incremental digger (4 days ago)
