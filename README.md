...
- :octocat: / [kedify/otel-add-on](https://github.com/kedify/otel-add-on) -  (2 weeks ago)
...
- 🎉 [giantswarm/cluster-test-suites](https://github.com/giantswarm/cluster-test-suites) ([v1.76.3](https://github.com/giantswarm/cluster-test-suites/releases/tag/v1.76.3), 5 days ago) - 
...
- 🎉 [giantswarm/cluster-cloud-director](https://github.com/giantswarm/cluster-cloud-director) ([v0.63.0](https://github.com/giantswarm/cluster-cloud-director/releases/tag/v0.63.0), 6 days ago) - App to provision a cluster with Cluster API provider VMware Cloud Director (VCD) using the Giant Swarm app platform
...
- [excalidraw/excalidraw-libraries](https://github.com/excalidraw/excalidraw-libraries) - Collection of publicly available libraries (2 weeks ago)
