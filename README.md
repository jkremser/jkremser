...
- :octocat: / [jkremser/kcd-2026-keda-otel-vllm](https://github.com/jkremser/kcd-2026-keda-otel-vllm) -  (4 weeks ago)
...
- 🎉 [kedacore/http-add-on](https://github.com/kedacore/http-add-on) ([v0.15.0](https://github.com/kedacore/http-add-on/releases/tag/v0.15.0), 4 days ago) - Add-on for KEDA to scale HTTP workloads
...
- 🎉 [kedacore/charts](https://github.com/kedacore/charts) ([v2.20.1](https://github.com/kedacore/charts/releases/tag/v2.20.1), 1 week ago) - Helm charts for KEDA

#### 🔨 My recent Pull Requests

- 💪 [Release chart also without v](https://github.com/kedify/otel-add-on/pull/222) on [kedify/otel-add-on](https://github.com/kedify/otel-add-on) (1 week ago)
