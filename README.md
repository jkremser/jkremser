...
- 🎉 [k8gb-io/k8gb](https://github.com/k8gb-io/k8gb) ([v0.15.0-rc3](https://github.com/k8gb-io/k8gb/releases/tag/v0.15.0-rc3), 1 day ago) - A cloud native Kubernetes Global Balancer
- 🎉 [kedacore/charts](https://github.com/kedacore/charts) ([v2.17.2](https://github.com/kedacore/charts/releases/tag/v2.17.2), 1 week ago) - Helm charts for KEDA
- 🎉 [kedacore/keda](https://github.com/kedacore/keda) ([v2.17.2](https://github.com/kedacore/keda/releases/tag/v2.17.2), 1 week ago) -  KEDA is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes 

#### 🔨 My recent Pull Requests

- 💪 [Bump http addon chart to v0.10.0-14 for agent helm chart](https://github.com/kedify/charts/pull/216) on [kedify/charts](https://github.com/kedify/charts) (1 day ago)
- 💪 [Bump kedify proxy in agent&#39;s values to 0.0.4](https://github.com/kedify/charts/pull/214) on [kedify/charts](https://github.com/kedify/charts) (1 day ago)
...
- [substratusai/kubeai](https://github.com/substratusai/kubeai) - AI Inference Operator for Kubernetes. The easiest way to serve ML models in production. Supports VLMs, LLMs, embeddings, and speech-to-text. (2 weeks ago)
- [amitv87/PiP](https://github.com/amitv87/PiP) - macOS Picture in Picture and AirPlay Receiver (3 weeks ago)
