...
- 🎉 [kedacore/charts](https://github.com/kedacore/charts) ([keda-add-ons-http-v0.11.0](https://github.com/kedacore/charts/releases/tag/keda-add-ons-http-v0.11.0), 6 days ago) - Helm charts for KEDA
...
- 💪 [fix: raw metrics over gRPC (sending to closed channel)](https://github.com/kedacore/keda/pull/7115) on [kedacore/keda](https://github.com/kedacore/keda) (2 days ago)
- 💪 [Add a section about consuming the raw metrics using gRPC.](https://github.com/kedacore/keda-docs/pull/1627) on [kedacore/keda-docs](https://github.com/kedacore/keda-docs) (2 days ago)
- 💪 [typo](https://github.com/kedify/examples/pull/81) on [kedify/examples](https://github.com/kedify/examples) (5 days ago)
