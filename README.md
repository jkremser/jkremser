...
- [jkremser/ebpf-playground](https://github.com/jkremser/ebpf-playground) - Tutorial of setting up eBPF enabled environment on Mac (4 weeks ago)
...
- [lima-vm/lima](https://github.com/lima-vm/lima) ([v0.11.1](https://github.com/lima-vm/lima/releases/tag/v0.11.1), 4 weeks ago) - Linux virtual machines, typically on macOS, for running containerd
...
- [📖 docs: update install instructions for kustomize and kubebuilder](https://github.com/kubernetes-sigs/cluster-api/pull/6931) on [kubernetes-sigs/cluster-api](https://github.com/kubernetes-sigs/cluster-api) (3 days ago)
...
- [sonatype-nexus-community/nancy](https://github.com/sonatype-nexus-community/nancy) - A tool to check for vulnerabilities in your Golang dependencies, powered by Sonatype OSS Index (4 days ago)
