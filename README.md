...
- 🎉 [kubernetes-sigs/cluster-api](https://github.com/kubernetes-sigs/cluster-api) ([v1.4.3](https://github.com/kubernetes-sigs/cluster-api/releases/tag/v1.4.3), 1 day ago) - Home for Cluster API, a subproject of sig-cluster-lifecycle
- 🎉 [giantswarm/devctl](https://github.com/giantswarm/devctl) ([v6.3.1](https://github.com/giantswarm/devctl/releases/tag/v6.3.1), 5 days ago) - Command line development utility.
- 🎉 [giantswarm/clustertest](https://github.com/giantswarm/clustertest) ([v0.0.14](https://github.com/giantswarm/clustertest/releases/tag/v0.0.14), 6 days ago) - A test framework for helping with E2E testing of cluster creation

#### 🔨 My recent Pull Requests

- 💪 [Add controlplane ip explicitly to certSANs list](https://github.com/giantswarm/cluster-vsphere/pull/70) on [giantswarm/cluster-vsphere](https://github.com/giantswarm/cluster-vsphere) (1 day ago)
- 💪 [Bump cluster-api-cleaner-cloud-director to 0.3.0](https://github.com/giantswarm/cloud-director-app-collection/pull/45) on [giantswarm/cloud-director-app-collection](https://github.com/giantswarm/cloud-director-app-collection) (6 days ago)

#### 📓 Gists I wrote

- [debug helm](https://gist.github.com/40bc6009eefdea63b57854becf8409a5) (6 days ago)
